...
class Visualization:
    ...
    def draw_orientation(self, image: np.ndarray, orientation: list):
        center = orientation[0]     
                
        box = cv2.boxPoints(orientation)
        box = np.int0(box)    
        ...
        # Draw and longer vector
        cv2.arrowedLine(image, center_pts, end_point, (0, 255, 0), 2)
        ...
        cv2.arrowedLine(image, center_pts, perp_end_point, (255, 0, 0), 2)
